...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Configura el manejador de archivos estáticos
        StaticHttpHandler staticHttpHandler = new StaticHttpHandler("./public/");
        server.getServerConfiguration().addHttpHandler(staticHttpHandler, "/");

        // Imprime el mensaje de inicio del servidor
        System.out.println(String.format("La aplicación Jersey ha comenzado con WADL disponible en "
                + "%sapplication.wadl\nPresiona enter para detenerla...", BASE_URI));

        // Espera la entrada del usuario para detener el servidor
        System.in.read();
        server.stop();
